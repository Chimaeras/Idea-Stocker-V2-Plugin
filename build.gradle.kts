...
dependencies {
    ...
    intellijPlatform {
        ...
        if (!localPath.isNullOrEmpty()) {
            // Use a locally installed IDE to avoid downloading distributions
            local(localPath)
        } else {
            // Fallback to downloading the specified IDE distribution
...
// Customize distribution file name for buildPlugin task without changing display name
tasks.named<org.gradle.api.tasks.bundling.Zip>("buildPlugin") {
    archiveBaseName.set("stocker-test")
}
